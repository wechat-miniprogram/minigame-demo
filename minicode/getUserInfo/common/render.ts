...
const button_left = layout.getElementsByClassName("button_left")[0] as Text;
const button_right = layout.getElementsByClassName("button_right")[0] as Text;
...
const renderLable = (value: string) => {
  const label = layout.getElementsByClassName('label')[0] as Text;
  if (label) {
    label.value = value;
  }
}

        ...
        {{?}}
            ...
            {{~it.data :item:index}}
                ...
                {{?}}
                    ...
                    <text class="listItemName" value="{{= (item.nickname || item.nickName).length > 10 ? (item.nickname || item.nickName).slice(0,10)+'...' : (item.nickname || item.nickName)}}"></text>
						{{? it.data.onLine }}

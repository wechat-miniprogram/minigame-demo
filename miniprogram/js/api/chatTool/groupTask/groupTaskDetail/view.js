...
export default function (PIXI, app, obj, callBack) {
    ...
    function refreshDraw(option) {
        const { isOwner, isUsingSpecify, participantCnt, taskCnt, targetTaskNum, isFinished, isParticipated, taskTitle, isParticipant } = option;
    ...
    container.addChild(goBack, title, 
    // api_name,
    // underline,
    taskTitleText, taskDetailText, smallShareBtn, participantBox);
